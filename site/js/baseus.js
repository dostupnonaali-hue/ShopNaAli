/**
 * ShopDoBaksa - Baseus Brand Page Logic (Ukrainian)
...
(function () {
    ...
    async function loadProducts() {
        try {
            ...
            // Filter: only products with "baseus" in the title
            brandProducts = allProducts.filter(function(p) {
                if (!p.title) return false;
                return p.title.toLowerCase().includes(BRAND_KEYWORD);
            });
    ...
    function renderProducts() {
        if (filteredProducts.length === 0) {
            productsGrid.innerHTML = '<div class="empty-state">' +
                ...
                '<h3 class="empty-state__title">\u0422\u043E\u0432\u0430\u0440\u0456\u0432 Baseus \u043F\u043E\u043A\u0438 \u043D\u0435\u043C\u0430\u0454</h3>' +
                '<p class="empty-state__text">\u041D\u043E\u0432\u0456 \u0442\u043E\u0432\u0430\u0440\u0438 Baseus \u0437\'\u044F\u0432\u043B\u044F\u0442\u044C\u0441\u044F \u0430\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0447\u043D\u043E \u2014 \u0437\u0430\u0445\u043E\u0434\u044C\u0442\u0435 \u0447\u0430\u0441\u0442\u0456\u0448\u0435!</p>' +
                '</div>';
            removeLoadMore();
            return;
        }
    ...
    function renderLoadMore() {
        ...
        wrapper.innerHTML = '<span class="load-more__counter">\u041F\u043E\u043A\u0430\u0437\u0430\u043D\u043E ' + shown + ' \u0437 ' + filteredProducts.length + '</span>' +
            '<button class="load-more__btn" onclick="window._loadMoreBaseus()">\uD83D\uDCE6 \u041F\u043E\u043A\u0430\u0437\u0430\u0442\u0438 \u0449\u0435</button>';
    ...
    function updateStats() {
        ...
        if (brandProducts.length > 0) {
            var usdProducts = brandProducts.filter(function(p) { return p.currency !== 'UAH'; });
            if (usdProducts.length > 0) {
                ...
                var minPrice = Math.min.apply(null, brandProducts.map(function(p) { return p.price; }));
